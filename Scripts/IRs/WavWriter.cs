...
{
    /// <summary>
    /// Saves a mono or interleaved buffer to a .wav file. Written by GPT-5.
    /// </summary>
    ...
    public static void Save(string fullPath, float[] samples, int sampleRate, int channels = 1, bool writeFloat32 = true)
    {
        ...
        using (var bw = new BinaryWriter(fs))
        {
            ...
            bw.Write((ushort)channels);            // NumChannels
